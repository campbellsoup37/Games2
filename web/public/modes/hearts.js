...
export class ClientStateHeartsPreGame extends ClientStateHearts {
...
export class ClientStateHeartsPlaying extends ClientStateHearts {
    constructor(key, client) {
        super(key, client, document.getElementById('inGameDiv'))
    }
...
export class ClientStateHeartsPostGame extends ClientStateHearts {
    constructor(key, client) {
...
class HeartsCanvas extends OhcCanvas {
    constructor(client) {
        super(client, false)
    ...
    initialize() {
        ...
        igLobby.addEventListener('click', () => {
            this.client.changeState('HEARTS_PREGAME')
        });
